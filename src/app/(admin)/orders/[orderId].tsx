...
const OrderDetailsScreen = () => {
    ...
    const onUpdate = (status: string) => {
        ...
        updateOrderStatus({ id: parseOrderId, status: status as OrderStatus });
    };
                    ...
                    <>
                        ...
                        <View style={styles.statusContainer}>
                            {status.map((item) => {
                                ...
                                return (
                                    <Pressable key={item} onPress={() => onUpdate(item)}>
                                        <Text
                                            style={[
                                                styles.statusText,
                                                {
                                                    backgroundColor: isSelected ? Colors.light.tint : undefined,
